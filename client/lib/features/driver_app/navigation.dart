                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                '${currentData['packages']} package${(currentData['packages'] as int) == 1 ? '' : 's'} to deliver',
                                style: TextStyle(
                                  fontSize: 15,
                                  fontWeight: FontWeight.w600,
                                  color: Theme.of(
                        ...
                        InkWell(
                          onTap: () {
                            context.push('/proof-delivery');
                            // Mocking advance route when returned
