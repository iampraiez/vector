...
export function Terms() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-emerald-100">
      ...
      {/* Content */}
      <main className="py-16 px-6 max-w-4xl mx-auto space-y-12">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-[15px] text-gray-600 font-medium pl-2">
            ...
            <li>
              Tracking individuals without their explicit consent (where
              required by law)
            </li>
            <li>
        ...
        <section className="space-y-4">
          ...
          <p className="text-[15px] text-gray-600 leading-relaxed font-medium">
            ...
            are and will remain the exclusive property of Vector Logistics
