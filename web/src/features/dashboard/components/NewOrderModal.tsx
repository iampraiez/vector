  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md p-0 gap-0 overflow-hidden border-none shadow-2xl rounded-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="p-5 md:p-6 overflow-y-auto space-y-4 bg-white">
          <ModalInput
            label="Customer Name *"
        ...
        <DialogFooter className="p-5 md:p-6 border-t border-gray-100 bg-gray-50 shrink-0 flex gap-3 sm:justify-between">
          <button
            onClick={onClose}
