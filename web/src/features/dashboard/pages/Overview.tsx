    ...
    <>
      <div className="p-4 md:p-8 max-w-350 mx-auto">
        ...
        {!isLoading && metrics && metrics.total_drivers === 0 && (
          <div className="mb-8 rounded-2xl bg-white border border-black/5 p-5 md:p-6 shadow-sm">
            <div className="flex flex-col md:flex-row md:items-center gap-5 justify-between">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[13px] text-gray-500 md:ml-11 max-w-xl">
                  Share your fleet code so drivers can join via the mobile app,
                  then create your first delivery.
                </p>
              </div>

              <div className="flex flex-wrap items-center gap-3 w-full md:w-auto md:shrink-0 md:ml-11">
                {/* Fleet Code Block */}
                <div className="flex items-center bg-gray-50/50 border border-black/5 rounded-xl pl-3 pr-1 py-1 gap-4">
                  ...
                  <button
                    ...
                    className="p-2 text-gray-400 hover:text-emerald-600 bg-white border border-black/5 hover:border-emerald-200 rounded-lg transition-colors cursor-pointer disabled:opacity-40"
